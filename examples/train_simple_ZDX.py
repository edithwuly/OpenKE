...
trainer.run()
simple.save_checkpoint('./checkpoint/simple_zdx.ckpt')
...
# predict
simple.load_checkpoint('./checkpoint/simple_zdx.ckpt')
...
fout = open("zdx_simple_prediction.txt", "w", encoding="utf-8")
