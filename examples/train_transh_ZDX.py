...
trainer.run()
transh.save_checkpoint('./checkpoint/transh_zdx.ckpt')
...
# predict
transh.load_checkpoint('./checkpoint/transh_zdx.ckpt')
...
fout = open("zdx_transh_prediction.txt", "w", encoding="utf-8")
