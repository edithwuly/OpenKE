...
trainer.run()
rescal.save_checkpoint('./checkpoint/rescal_nkx.ckpt')
...
# predict
rescal.load_checkpoint('./checkpoint/rescal_nkx.ckpt')
...
fout = open("nkx_rescal_prediction.txt", "w", encoding="utf-8")
