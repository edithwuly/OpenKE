...
trainer.run()
transd.save_checkpoint('./checkpoint/transd_zdx.ckpt')
...
# predict
transd.load_checkpoint('./checkpoint/transd_zdx.ckpt')
...
fout = open("zdx_transd_prediction.txt", "w", encoding="utf-8")
