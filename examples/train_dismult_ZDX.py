...
trainer.run()
distmult.save_checkpoint('./checkpoint/distmult_zdx.ckpt')
...
# predict
distmult.load_checkpoint('./checkpoint/distmult_zdx.ckpt')
...
fout = open("zdx_distmult_prediction.txt", "w", encoding="utf-8")
