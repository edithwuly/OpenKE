...
trainer.run()
transr.save_checkpoint('./checkpoint/transr_nkx.ckpt')
...
# predict
transr.load_checkpoint('./checkpoint/transr_nkx.ckpt')
...
fout = open("nkx_transr_prediction.txt", "w", encoding="utf-8")
