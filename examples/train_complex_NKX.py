...
trainer.run()
complEx.save_checkpoint('./checkpoint/complEx_nkx.ckpt')
...
# predict
complEx.load_checkpoint('./checkpoint/complEx_nkx.ckpt')
...
fout = open("nkx_complEx_prediction.txt", "w", encoding="utf-8")
