...
trainer.run()
analogy.save_checkpoint('./checkpoint/analogy_nkx.ckpt')
...
# predict
analogy.load_checkpoint('./checkpoint/analogy_nkx.ckpt')
...
fout = open("nkx_analogy_prediction.txt", "w", encoding="utf-8")
