...
trainer.run()
rotate.save_checkpoint('./checkpoint/rotate_zdx.ckpt')
...
# predict
rotate.load_checkpoint('./checkpoint/rotate_zdx.ckpt')
...
fout = open("zdx_rotate_prediction.txt", "w", encoding="utf-8")
